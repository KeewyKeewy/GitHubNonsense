...
BAN = ['bit.ly', 'goo.gl', '.gu.ma', 'ow.ly', ".3utilities.com", ".gotdns.", ".myftp.", "3cm.ky", "http://t.co", '.myvnc.', 'make.my/', 'bounceme.net', 'youtubee.', '.serveftp.', 'sn.im/', '/t.co', 'redirectme.net', 'servebeer.com', 'servecounterstrike.com/', 'webhop.me/', 'tondermore.tk', 'prntcsr.pw']
